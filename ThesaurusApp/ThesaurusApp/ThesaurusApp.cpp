// ThesaurusApp.cpp : Defines the entry point for the console application.
//
...
void print(int a)
{
	switch(a)
	{
		case 1:printf("\nWord recognized as\n\"Important\": Critical, Urgent, Vital, Large, Decisive\n");
			break;
		case 2:printf("\nWord recognized as\n\"Good\": Great, Superb, Excellent, Wonderful, Marvelous\n");
			break;
		case 3:printf("\nWord recognized as\n\"Bad\": Awful, Cheap, Dreadful, Poor, Unacceptable\n");
			break;	
		case 4:printf("\nWord recognized as\n\"Cool\": Chily, Cold, Frosty, Arctic, Frigid\n");
			break;
		case 5:printf("\nWord recognized as\n\"Begin\": Start, Commence, Undertake, Launch, Create\n");
			break;
		case 6:printf("\nWord recognized as\n\"End\": Stop, Delay, Drop, Quit, Halt\n");
			break;
		case 7:printf("\nWord recognized as\"Bright\": Brilliant, Dazzling, Flashing, Intense, Radiant\n");
			break;
		case 8:printf("\nWord recognized as\"Complete\": Entire, Exhaustive, Full, All, Uncut\n");
			break;
		case 9:printf("\nWord recognized as\n\"Big\": Colossal, Full, Massive, Gigantic, Huge\n");
			break;
		case 10:printf("\nWord recognized as\n\"Small\": Cramped, Limited, Short, Narrow, Miniature\n");
			break;
	}
}
